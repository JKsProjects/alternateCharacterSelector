...
let fontBlocks = {
	...
	"Circled": new FontBlock(0x24b6, 0x24d0, 0x245f, {"0": 0x30}),
    "Regional Indicators": new FontBlock(0x1f1e6, 0x1f1e6, undefined),
    "Parentheses": new FontBlock(0x1f110, 0x249c, 0x2473, {"0": 0x30})
};
